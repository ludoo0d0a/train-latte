    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to Train latte
        </h2>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          <a href="http://localhost:3000/api/tweets/login" target="_blank" class="button--doc text-green-500 hover:underline">Login OAuh2 Twitter</a>
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          <a href="http://localhost:3000/api/tweets/traffic" target="_blank" class="button--doc text-green-500 hover:underline">Get traffic endpoint</a>
        </p>
      </div>
